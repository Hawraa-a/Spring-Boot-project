...
public class DepartmentController {
    ...
    @PostMapping("create")
    public DepartmentCreateResponse createDepartment(@RequestBody DepartmentCreateRequest requestObj) throws Exception {
        DepartmentCreateRequest.validCreateDepartmentRequest(requestObj);
        return departmentService.saveDepartment(requestObj);
    }
